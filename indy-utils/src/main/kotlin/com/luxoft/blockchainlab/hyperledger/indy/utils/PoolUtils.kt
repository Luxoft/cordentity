...
object PoolUtils {
    ...
    @Throws(InterruptedException::class, ExecutionException::class, IndyException::class, IOException::class)
    @JvmOverloads
    ...
    fun createPoolLedgerConfig(poolName: String, nodesCnt: Int) {
    ...
    @Throws(IndyException::class, InterruptedException::class, ExecutionException::class, IOException::class)
